...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: &quot;ca-pub-4453828320892497&quot;,
...
<meta content='Kumpulan Tutorial Komputer, Android, Blogging dan Pemrograman' name='keywords'/></b:if>
...
<link href='https://plus.google.com/110586407021652741964/posts' rel='publisher'/>
<link href='https://plus.google.com/110586407021652741964/about' rel='author'/>
<link href='https://plus.google.com/110586407021652741964' rel='me'/>
<meta content='Q46mX16V7Orr8qWhGzNG1OcUSwJz7irnab9U_-3Q7JM' name='google-site-verification'/>
<meta content='08435C0AAB5666F16998C57488DD243B' name='msvalidate.01'/>
<meta content='e8da5a5b6be7e25a' name='yandex-verification'/>
<meta content='Indonesia' name='geo.placename'/>
<meta content='Muhammad Ghifari Arfananda' name='Author'/>
...
<meta content='https://www.facebook.com/uchia.arfan' property='article:author'/>
<meta content='https://www.facebook.com/uchiha.arfan' property='article:publisher'/>
<meta content='272528469996776' property='fb:app_id'/>
<meta content='100008092862184' property='fb:admins'/>
...
/* Variable definitions start
   ==========================
   <Variable name="keycolor" description="Main Color" type="color" default="#43ce8e" value="#43ce8e"/>

   <Group description="Page Text" selector="body">
     <Variable name="body.font" description="Font" type="font"
         default="normal normal 16px Roboto, sans-serif" value="normal normal 16px Roboto, sans-serif"/>
     <Variable name="body.text.color" description="Main Text Color" type="color" default="#777777" value="#777777"/>
   </Group>

   <Group description="Backgrounds" selector=".body-fauxcolumns-outer">
     <Variable name="body.background.color" description="Body" type="color" default="#ffffff" value="#ffffff"/>
     <Variable name="header.background.color" description="Header" type="color" default="#43ce8e" value="#43ce8e"/>
   ...
   <Group description="Links" selector=".main-outer">
     <Variable name="link.color" description="Link Color" type="color" default="#2196f3" value="#2196f3"/>
     <Variable name="link.visited.color" description="Visited Color" type="color" default="#2196f3" value="#2196f3"/>
     <Variable name="link.hover.color" description="Hover Color" type="color" default="#1976d2" value="#1976d2"/>
   </Group>

   <Group description="Blog Title" selector=".header">
     <Variable name="header.font" description="Font" type="font"
         default="700 20px Roboto, sans-serif" value="700 20px Roboto, sans-serif"/>
   ...
   <Group description="Navigation Menu" selector="#cssmenu">
     <Variable name="navmenu.font" description="Font" type="font"
         default="500 12px Roboto, sans-serif" value="500 12px Roboto, sans-serif"/>
   ...
   <Group description="Post Title" selector="h2.post-title, .FeaturedPost .post-summary h3">
     <Variable name="post.title.font" description="Font" type="font"
         default="700 20px Roboto, sans-serif" value="700 20px Roboto, sans-serif"/>
	 <Variable name="post.title.color" description="Link Color" type="color" default="#5a5a5a" value="#5a5a5a"/>
	 <Variable name="post.title.hover.color" description="Link Hover Color" type="color" default="#43ce8e" value="#43ce8e"/>
   </Group>
   ...
   <Group description="Widget Title" selector=".sidebar h2, .sidebar-sticky h2, .latest-post-title h2, .above-post-widget h2">
     <Variable name="widget.title.font" description="Title Font" type="font"
        default="700 14px Roboto, sans-serif" value="700 14px Roboto, sans-serif"/>
	 <Variable name="widget.title.color" description="Color" type="color" default="#1976d2" value="#1976d2"/>
	 <Variable name="widget.border.color" description="Border Color" type="color" default="#ececec" value="#ececec"/>
   </Group>

   <Group description="Label" selector=".label-info-th">
     <Variable name="label.bg.color" description="Background" type="color" default="#f8f8f8" value="#f8f8f8"/>
	 <Variable name="label.color" description="Color" type="color" default="#888888" value="#888888"/>
	 <Variable name="label.border.color" description="Border Color" type="color" default="#dddddd" value="#dddddd"/>
	 <Variable name="label.hover.border.color" description="Hover Color" type="color" default="#777" value="#777777"/>
   </Group>

   <Group description="Post Body" selector=".post-body, .post-snippet">
     <Variable name="post.body.font" description="Font" type="font"
         default="normal normal 16px Roboto, sans-serif" value="normal normal 16px Roboto, sans-serif"/>
	 <Variable name="post.body.color" description="Color" type="color" default="#777777" value="#777777"/>
   </Group>
   
   <Group description="Post Footer" selector=".post-info">
     <Variable name="post.footer.font" description="Font" type="font"
         default="normal normal 13px Roboto, sans-serif" value="normal normal 13px Roboto, sans-serif"/>
     <Variable name="post.footer.color" description="Color" type="color" default="#999999" value="#999999"/>
   </Group>
   ...
   <Group description="Footer Navigation Menu" selector="#footer-navmenu">
     <Variable name="navmenufooter.font" description="Font" type="font"
         default="500 14px Roboto, sans-serif" value="500 14px Roboto, sans-serif"/>
   ...
   <Group description="Back to Top" selector="#back-to-top"> 
     <Variable name="backtp.background.color" description="Background" type="color" default="#43ce8e" value="#37474f"/>
...
.post-body {-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}
.post-snippet{color: #888888;}
...
a:link{color:#2196f3;text-decoration:none;outline:none;}
...
/* heading */
h1,h2,h3,h4,h5,h6 {
margin: 0 0 0.6em;font-weight:700;
}
...
.post-body blockquote{background:#f8cf82;color:#000;font-size:15px;position:relative;padding:1.2em 1.5em;margin:1em auto;overflow:hidden;text-align:left;word-spacing:0}.post-body blockquote:before{content:"";position:absolute;top:0;right:0;border-width:0 16px 16px 0;border-style:solid;border-color:#fff #fff #d8b471 #d8b471;background:#d8b471;display:block;width:0}.post-body blockquote:hover:before{display:none}pre{white-space:pre;word-wrap:normal;overflow:auto;font-size:14px;margin:0}
/* table */
...
.cloud-label-widget-content:hover{
cursor: pointer;
}
.label-size {
...
color: #ffffff;
font: 500 'Roboto Condensed', sans-serif;
}
.label-count {
margin-left: -12px;
margin-right: 0px;
...
font: 700 20px Roboto Bold, sans-serif;
position: absolute;
bottom: 58px;
z-index: 1;
font-size: 28px;
...
#back-to-top:hover{background:#263238;}
.back-to-top {
...
background: #292929;
padding: 15px 0px;
font: 500 14px Roboto Bold, sans-serif;
color: #ffffff;
}
...
.related-post{font-family:&#39;Roboto&#39;, sans-serif;margin:10px 0 10px -4px;padding:0;font-size:13px;text-align:left;box-sizing:border-box}
.related-post,.related-post-style-3 .related-post-item{-moz-box-sizing:border-box;-webkit-box-sizing:border-box}
.related-post-style-3,.related-post-style-3 li{margin:0!important;padding:0!important;list-style:none;word-wrap:break-word;overflow:hidden}
.related-post-style-3 .related-post-item{display:block;float:left;width:25%;height:180px;padding-left:4px!important;margin:0 0 4px!important;box-sizing:border-box}
...
.related-post-style-3 .related-post-item-tooltip{padding: 0 4px;overflow:hidden;text-overflow:ellipsis;display:block;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}
.related-post-style-3 .related-post-item-tooltip a.related-post-item-title{font-family: &#39;Roboto&#39;, sans-serif; font-size: 12px;color:#444!important;font-weight:700;}
.related-post-style-3 .related-post-item-tooltip a.related-post-item-title:hover{text-decoration:none;}
      ...
      gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() {
        if (gapi.iframes &amp;&amp; gapi.iframes.getContext) {
          gapi.iframes.getContext().openChild({
              url: &#39;https://www.blogger.com/navbar.g?targetBlogID\x3d4296026618699466047\x26blogName\x3dPanduan+Kompi\x26publishMode\x3dPUBLISH_MODE_HOSTED\x26navbarType\x3dDISABLED\x26layoutType\x3dLAYOUTS\x26searchRoot\x3dhttps://www.panduankompi.xyz/search\x26blogLocale\x3din\x26v\x3d2\x26homepageUrl\x3dhttps://www.panduankompi.xyz/\x26vt\x3d8742124211816390663&#39;,
...
<div id='header-container'>  
  ...
  <b:section class='header' id='header' maxwidgets='1' showaddelement='no'>
      <b:widget id='Header1' locked='true' title='Panduan Kompi (Header)' type='Header' version='1'>
        <b:widget-settings>
...
<ul>
  ...
  <li>
	<a href='#'>Tutorial</a>
    <ul>
    <li><a href='/search/label/Tutorial'>Semua Tutorial</a></li>
	<li><a href='/search/label/Adsense'>Adsense</a></li>
    <li><a href='/search/label/Android'>Android</a></li>
    <li><a href='/search/label/Tutorial Blog'>Blog</a></li>
    <li><a href='/search/label/Tutorial Komputer'>Komputer</a></li>
    </ul>
  </li>
...
<button class='close' type='button'>&#215;</button>
  ...
  <b:section class='bellow-header-widget' id='bellow-header-widget' maxwidgets='1' showaddelement='yes'>
    <b:widget id='HTML1' locked='false' title='Artikel Terbaru' type='HTML'>
      <b:widget-settings>
        <b:widget-setting name='content'>&lt;!-- link --&gt;
&lt;ins class=&quot;adsbygoogle&quot;
     style=&quot;display:block&quot;
     data-ad-client=&quot;ca-pub-4453828320892497&quot;
     data-ad-slot=&quot;2375130528&quot;
...
&lt;/script&gt;</b:widget-setting>
  ...
  <b:section class='above-post-widget' id='above-post-widget' maxwidgets='1' showaddelement='yes'>
     <b:widget id='FeaturedPost1' locked='false' title='Artikel Pilihan' type='FeaturedPost'>
       <b:widget-settings>
         <b:widget-setting name='showSnippet'>true</b:widget-setting>
         <b:widget-setting name='showPostTitle'>true</b:widget-setting>
         <b:widget-setting name='postId'>8575282833499694079</b:widget-setting>
  ...
  <b:section class='main' id='main' showaddelement='no'>
    <b:widget id='Blog1' locked='true' title='Posting Blog' type='Blog' version='1'>
      <b:widget-settings>
        ...
        <b:widget-setting name='style.textcolor'>#777777</b:widget-setting>
        <b:widget-setting name='showCommentLink'>true</b:widget-setting>
        <b:widget-setting name='style.urlcolor'>#2196f3</b:widget-setting>
        <b:widget-setting name='showAuthor'>true</b:widget-setting>
        <b:widget-setting name='style.linkcolor'>#2196f3</b:widget-setting>
  ...
  <p class='comment-footer'>
    <a class='comment-link' expr:href='data:post.createLinkUrl' expr:id='data:widget.instanceId + &quot;_backlinks-create-link&quot;' target='_blank'><data:post.createLinkLabel/></a>
      ...
      <b:else/>
        ...
        <div class='breadcrumbs'><span itemscope='' itemtype='https://data-vocabulary.org/Breadcrumb'><a expr:href='data:blog.homepageUrl' itemprop='url'><span itemprop='title'>Home</span></a></span> &#8250; <b:loop values='data:post.labels' var='label'><span itemscope='' itemtype='https://data-vocabulary.org/Breadcrumb'><a expr:href='data:label.url + &quot;?&amp;max-results=8&quot;' itemprop='url'><span itemprop='title'><data:label.name/></span></a></span><b:if cond='data:label.isLast != &quot;true&quot;'> &#8250; </b:if> </b:loop>
        </div>
        <b:else/>
  ...
  <b:else/>
    ...
    <b:else/>
      ...
      <script type='text/javascript'>
      var disqus_shortname = &quot;panduankompi&quot;;
      ...
      //<![CDATA[
      function load_Comments(){var e=document.getElementById("disqusshow");e.style.display="none";var t="panduankompi";!function(){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://"+t+".disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(e)}()}
      //]]>
      </script>
      </b:if>
	  <!-- Disqus Comment End -->
...
<b:if cond='data:post.allowComments'>
  <span class='comment-info'>
  <a expr:href='data:post.url + &quot;#disqus_thread&quot;' expr:onclick='data:post.addCommentOnclick' title='Comments'> <b:if cond='data:post.numComments == 0'> Add Comment </b:if> <b:if cond='data:post.numComments == 1'>1 Comment</b:if><b:if cond='data:post.numComments &gt; 1'><data:post.numComments/> Comments</b:if> 
  </a>
  </span>
</b:if>
</b:includable>
...
<div class='berlangganan-box'>
	<form action='https://feedburner.google.com/fb/a/mailverify' method='post' onsubmit='window.open(&apos;https://feedburner.google.com/fb/a/mailverify?uri=panduankompi&apos;, &apos;popupwindow&apos;, &apos;scrollbars=yes,width=550,height=520&apos;);return true' target='popupwindow'>
  ...
  <b:else/>
	<a expr:href='data:post.url'><img expr:alt='data:post.title' expr:title='data:post.title' src='//3.bp.blogspot.com/-ltyYh4ysBHI/U04MKlHc6pI/AAAAAAAADQo/PFxXaGZu9PQ/w255-h170-c/no-image.png'/>
      ...
      <b:includable id='relatedpost' var='post'>
		 <b:if cond='data:blog.pageType == &quot;item&quot;'>
<div class='label-line-c'>
<p class='share-this-pleaseeeee'>Related Posts</p>
</div>
<div class='related-post' id='related-post'/>
<script type='text/javascript'>
var labelArray = [<b:if cond='data:post.labels'><b:loop values='data:post.labels' var='label'>&quot;<data:label.name/>&quot;<b:if cond='data:label.isLast != &quot;true&quot;'>,</b:if></b:loop></b:if>];var relatedPostConfig={homePage:&quot;<data:blog.homepageUrl/>&quot;,widgetTitle:&quot;&quot;,numPosts:8,summaryLength:0,titleLength:&quot;30&quot;,thumbnailSize:172,noImage:&quot;data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAAA3NCSVQICAjb4U/gAAAADElEQVQImWOor68HAAL+AX7vOF2TAAAAAElFTkSuQmCC&quot;,containerId:&quot;related-post&quot;,newTabLink:false,moreText:&quot;Read More&quot;,widgetStyle:3,callBack:function(){}}
</script>
</b:if>
	  </b:includable>
...
&lt;/script&gt;</b:widget-setting>
  ...
  <b:section class='iklan-tengah1' id='iklan-tengah1' maxwidgets='1' showaddelement='yes'>
      <b:widget id='HTML997' locked='true' title='Iklan Tengah Artikel 1' type='HTML' version='1'>
        <b:widget-settings>
          <b:widget-setting name='content'>&lt;!-- ads_kotak --&gt;
&lt;ins class=&quot;adsbygoogle&quot;
     style=&quot;display:inline-block;width:336px;height:280px&quot;
     data-ad-client=&quot;ca-pub-4453828320892497&quot;
     data-ad-slot=&quot;2681469438&quot;&gt;&lt;/ins&gt;
&lt;script&gt;
(adsbygoogle = window.adsbygoogle || []).push({});
&lt;/script&gt;</b:widget-setting>
        </b:widget-settings>
  ...
  <b:section class='iklan-tengah2' id='iklan-tengah2' maxwidgets='1' showaddelement='yes'>
    <b:widget id='HTML998' locked='true' title='Iklan Tengah Artikel 2' type='HTML' version='1'>
      <b:widget-settings>
        <b:widget-setting name='content'>&lt;!-- ads_kotak_2 --&gt;
&lt;ins class=&quot;adsbygoogle&quot;
     style=&quot;display:inline-block;width:336px;height:280px&quot;
     data-ad-client=&quot;ca-pub-4453828320892497&quot;
     data-ad-slot=&quot;9337527061&quot;&gt;&lt;/ins&gt;
&lt;script&gt;
(adsbygoogle = window.adsbygoogle || []).push({});
&lt;/script&gt;</b:widget-setting>
      </b:widget-settings>
...
if (lokasi.length &gt; 4) {
  ...
  <b:section class='sidebar' id='sidebar' preferred='yes'>
    <b:widget id='HTML4' locked='false' title='Recent Post' type='HTML'>
      <b:widget-settings>
        <b:widget-setting name='content'>&lt;div class=&#39;artikel-terbaru&#39;&gt;
&lt;script&gt;
...
&lt;/div&gt;</b:widget-setting>
  ...
  <b:include name='quickedit'/>
    ...
    <b:widget id='HTML3' locked='false' title='Fanpage' type='HTML'>
      <b:widget-settings>
        <b:widget-setting name='content'><![CDATA[<div class="fb-page" data-href="https://www.facebook.com/209297563074009/" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/209297563074009/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/209297563074009/">Panduan Kompi</a></blockquote></div>]]></b:widget-setting>
      </b:widget-settings>
      <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:include name='quickedit'/>
    ...
    <b:widget id='Label1' locked='false' title='Labels' type='Label'>
      <b:widget-settings>
        ...
        <b:widget-setting name='selectedLabelsList'>Adsense,Android,Internet,Komputer,Smartphone,Tutorial,Tutorial Blog,Tutorial Komputer</b:widget-setting>
  ...
  <b:section class='sidebar-sticky' id='sidebar-sticky' preferred='yes'>
    <b:widget id='HTML2' locked='false' title='' type='HTML'>
      <b:widget-settings>
        <b:widget-setting name='content'>&lt;!-- responsif --&gt;
&lt;ins class=&quot;adsbygoogle&quot;
     style=&quot;display:block&quot;
     data-ad-client=&quot;ca-pub-4453828320892497&quot;
     data-ad-slot=&quot;2730353740&quot;
...
<!-- menu navigasi footer end -->
  ...
  <footer id='footer-wrapper'>
		Copyright 2018 <a expr:href='data:blog.homepageUrl'><data:blog.title/></a>
  </footer>
  </div>
  <!-- footer wrapper end --> 
...
<script>(function(d, s, id) {
  ...
  js.src = &#39;https://connect.facebook.net/id_ID/sdk.js#xfbml=1&amp;version=v3.0&amp;appId=272528469996776&amp;autoLogAppEvents=1&#39;;
...
loadCSS("https://fonts.googleapis.com/css?family=Roboto:400,500,700|Roboto+Slab:400,700|Noto+Sans:400,700");loadCSS("https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css");loadCSS("https://cdn.jsdelivr.net/lightgallery/1.3.9/css/lightgallery.css");
// Double Click
...
<script type='text/javascript'>
//<![CDATA[
(function() { var ka = document.createElement('script'); ka.type = 'text/javascript'; ka.async = true; ka.src = 'https://platform-api.sharethis.com/js/sharethis.js#property=5b3a0fa547b80c00119662b5&amp;product=social-analytics'; var ba = document.getElementsByTagName('script')[0]; ba.parentNode.insertBefore(ka, ba); })();
//]]>
</script>
<script type='text/javascript'>
//<![CDATA[
...
<script type='text/javascript'>
//<![CDATA[
var randomRelatedIndex,showRelatedPost;(function(n,m,k){var d={widgetTitle:"",widgetStyle:1,homePage:"http://www.dte.web.id",numPosts:8,summaryLength:300,titleLength:"auto",thumbnailSize:200,noImage:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAAA3NCSVQICAjb4U/gAAAADElEQVQImWOor68HAAL+AX7vOF2TAAAAAElFTkSuQmCC",containerId:"related-post",newTabLink:false,moreText:"Baca Selengkapnya",callBack:function(){}};for(var f in relatedPostConfig){d[f]=(relatedPostConfig[f]=="undefined")?d[f]:relatedPostConfig[f]}var j=function(a){var b=m.createElement("script");b.type="text/javascript";b.src=a;k.appendChild(b)},o=function(b,a){return Math.floor(Math.random()*(a-b+1))+b},l=function(a){var p=a.length,c,b;if(p===0){return false}while(--p){c=Math.floor(Math.random()*(p+1));b=a[p];a[p]=a[c];a[c]=b}return a},e=(typeof labelArray=="object"&&labelArray.length>0)?"/-/"+l(labelArray)[0]:"",h=function(b){var c=b.feed.openSearch$totalResults.$t-d.numPosts,a=o(1,(c>0?c:1));j(d.homePage.replace(/\/$/,"")+"/feeds/posts/summary"+e+"?alt=json-in-script&orderby=updated&start-index="+a+"&max-results="+d.numPosts+"&callback=showRelatedPost")},g=function(z){var s=document.getElementById(d.containerId),x=l(z.feed.entry),A=d.widgetStyle,c=d.widgetTitle+'<ul class="related-post-style-'+A+'">',b=d.newTabLink?' target="_blank"':"",y='<span style="display:block;clear:both;"></span>',v,t,w,r,u;if(!s){return}for(var q=0;q<d.numPosts;q++){if(q==x.length){break}t=x[q].title.$t;w=(d.titleLength!=="auto"&&d.titleLength<t.length)?t.substring(0,d.titleLength)+"&hellip;":t;r=("media$thumbnail"in x[q]&&d.thumbnailSize!==false)?x[q].media$thumbnail.url.replace(/.*?:\/\//g , "//").replace(/\/s[0-9]+(\-c)?/, "/s"+d.thumbnailSize):d.noImage;u=("summary"in x[q]&&d.summaryLength>0)?x[q].summary.$t.replace(/<br ?\/?>/g," ").replace(/<.*?>/g,"").replace(/[<>]/g,"").substring(0,d.summaryLength)+"&hellip;":"";for(var p=0,a=x[q].link.length;p<a;p++){v=(x[q].link[p].rel=="alternate")?x[q].link[p].href:"#"}if(A==2){c+='<li><img alt="" class="related-post-item-thumbnail" src="'+r+'" width="'+d.thumbnailSize+'" height="'+d.thumbnailSize+'"><a class="related-post-item-title" title="'+t+'" href="'+v+'"'+b+">"+w+'</a><span class="related-post-item-summary"><span class="related-post-item-summary-text">'+u+'</span> <a href="'+v+'" class="related-post-item-more"'+b+">"+d.moreText+"</a></span>"+y+"</li>"}else{if(A==3||A==4){c+='<li class="related-post-item" tabindex="0"><a class="related-post-item-title" href="'+v+'"'+b+'><img alt="" class="related-post-item-thumbnail" src="'+r+'" width="'+d.thumbnailSize+'" height="'+d.thumbnailSize+'"></a><div class="related-post-item-tooltip"><a class="related-post-item-title" title="'+t+'" href="'+v+'"'+b+">"+w+"</a></div>"+y+"</li>"}else{if(A==5){c+='<li class="related-post-item" tabindex="0"><a class="related-post-item-wrapper" href="'+v+'" title="'+t+'"'+b+'><img alt="" class="related-post-item-thumbnail" src="'+r+'" width="'+d.thumbnailSize+'" height="'+d.thumbnailSize+'"><span class="related-post-item-tooltip">'+w+"</span></a>"+y+"</li>"}else{if(A==6){c+='<li><a class="related-post-item-title" title="'+t+'" href="'+v+'"'+b+">"+w+'</a><div class="related-post-item-tooltip"><img alt="" class="related-post-item-thumbnail" src="'+r+'" width="'+d.thumbnailSize+'" height="'+d.thumbnailSize+'"><span class="related-post-item-summary"><span class="related-post-item-summary-text">'+u+"</span></span>"+y+"</div></li>"}else{c+='<li><a title="'+t+'" href="'+v+'"'+b+">"+w+"</a></li>"}}}}}s.innerHTML=c+="</ul>"+y;d.callBack()};randomRelatedIndex=h;showRelatedPost=g;j(d.homePage.replace(/\/$/,"")+"/feeds/posts/summary"+e+"?alt=json-in-script&orderby=updated&max-results=0&callback=randomRelatedIndex")})(window,document,document.getElementsByTagName("head")[0]);
//]]>
</script>
</b:if>
&lt;!--</body>--&gt;&lt;/body&gt;
